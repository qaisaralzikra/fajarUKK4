...
<div class="sidebar">
    ...
    <nav class="nav flex-column mt-3">
        <a class="nav-link active" href="<?= base_url('user/dashboard'); ?>"><i class="fas fa-tachometer-alt me-2"></i><span>Dashboard</span></a>
            ...
            <div class="card card-custom border-primary-custom h-100 py-2 bg-white">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            <div class="stat-label text-primary mb-1">Jumlah Transaksi</div>
        ...
        <div class="col-xl-4 col-md-6 mb-4">
            <div class="card card-custom border-success-custom h-100 py-2 bg-white">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            <div class="stat-label text-success mb-1">Jumlah Buku Tersedia</div>
                            <div class="stat-value"><?= $jumlah_buku_tersedia; ?></div>
                        </div>
                        <div class="col-auto"><i class="fas fa-book fa-2x text-gray-200"></i></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-8">
            <div class="card shadow mb-4">
                <div class="card-header py-3 bg-white d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?= base_url('user/library'); ?>" class="btn btn-sm btn-primary">Lihat Semua</a>
                </div>
