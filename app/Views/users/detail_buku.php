...
<body>
    ...
    <div class="main-content">
        ...
        <div class="card p-4 flex flex-row w-100 gap-4">
            ...
            <div style="width: 700px;">
                ...
                <button data-bs-toggle="modal" data-bs-target="#addBookModal" class="bg-primary py-3 px-6 text-white rounded-2 btn">Tambah Ke Keranjang</button>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="addBookModal" tabindex="-1">
        <div class="modal-dialog">
            <form action="<?= base_url('user/tambah/keranjang/' . $buku['id']); ?>" method="post" class="modal-content">
                <?= csrf_field(); ?>
