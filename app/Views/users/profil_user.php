...
<body>
    ...
    <div class="sidebar">
        ...
        <nav class="nav flex-column mt-3">
            ...
            <a class="nav-link active" href="<?= base_url('profil/user'); ?>"><i class="fas fa-user me-2"></i><span>Profil</span></a>
            <div class="mt-5 p-3">
    ...
    <div class="main-content">
        <div class="profile-card">
            <div class="profile-photo relative">
                <img src="<?= base_url('foto/user/' . ($foto ?: 'default.jpg')); ?>" class="book-cover-table w-[300px] h-[200px] absolute" alt="cover">
            </div>
