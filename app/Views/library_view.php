...
<body>
    ...
    <div class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <button class="btn btn-primary shadow-sm" data-bs-toggle="modal" data-bs-target="#addBookModal">
                <i class="fas fa-plus fa-sm text-white-50 me-2"></i> Tambah Buku
            </button>
        </div>
            ...
            <table class="table table-hover align-middle">
                ...
                <tbody>
                    <?php foreach ($books as $b): ?>
                        <tr onclick="window.location='<?= base_url('buku/detail/' . $b['id']); ?>';" style="cursor: pointer;" class="hover-effect">
                            <td>
                            ...
                            <td>
                                <a href="<?= base_url('library/delete/' . $b['id']); ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('Hapus buku ini?')">
    ...
    <div class="modal fade" id="addBookModal" tabindex="-1">
        <div class="modal-dialog">
            <form action="<?= base_url('library/save'); ?>" method="post" enctype="multipart/form-data" class="modal-content">
                <?= csrf_field(); ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="deskripsi" class="form-control" placeholder="Masukkan judul" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Tanggal Terbit</label>
                        <input type="date" name="terbit" class="form-control" placeholder="Masukkan judul" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="stok" class="form-control" placeholder="Nama penulis" required>
                    </div>
                    <div class="mb-3">
